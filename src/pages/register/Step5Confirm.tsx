...
import { RegistrationData, HOSPITAL_TYPES, BED_COUNTS } from "./constants";
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Review your details before we create your hospital account</p>
      </div>
